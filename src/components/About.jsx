  ...
  return (
    ...
    >
      <div className="max-w-screen-lg p-4 max-[520px]:mt-16 mx-auto flex flex-col justify-center w-full h-full">
        ...
        <br />
        <p className="text-xl">
          I Having Experince As Purchase Engineer At Gmr power Plant For 2year.I am passionate about creating solutions that make a positive impact on the environment and society.
        </p>
      </div>
    </div>
  );
